...
func (c *lomsClient) CreateOrder(ctx context.Context, in *CreateOrderRequest, opts ...grpc.CallOption) (*CreateOrderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gitlab.ozon.dev.ipogiba.homework.loms.pkg.api.loms.v1.Loms/CreateOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lomsClient) OrderInfo(ctx context.Context, in *OrderInfoRequest, opts ...grpc.CallOption) (*OrderInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gitlab.ozon.dev.ipogiba.homework.loms.pkg.api.loms.v1.Loms/OrderInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lomsClient) OrderPay(ctx context.Context, in *OrderPayRequest, opts ...grpc.CallOption) (*OrderPayResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gitlab.ozon.dev.ipogiba.homework.loms.pkg.api.loms.v1.Loms/OrderPay", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lomsClient) OrderCancel(ctx context.Context, in *OrderCancelRequest, opts ...grpc.CallOption) (*OrderCancelResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gitlab.ozon.dev.ipogiba.homework.loms.pkg.api.loms.v1.Loms/OrderCancel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lomsClient) StocksInfo(ctx context.Context, in *StocksInfoRequest, opts ...grpc.CallOption) (*StocksInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gitlab.ozon.dev.ipogiba.homework.loms.pkg.api.loms.v1.Loms/StocksInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Loms_CreateOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gitlab.ozon.dev.ipogiba.homework.loms.pkg.api.loms.v1.Loms/CreateOrder",
	}
...
func _Loms_OrderInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gitlab.ozon.dev.ipogiba.homework.loms.pkg.api.loms.v1.Loms/OrderInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Loms_OrderPay_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gitlab.ozon.dev.ipogiba.homework.loms.pkg.api.loms.v1.Loms/OrderPay",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Loms_OrderCancel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gitlab.ozon.dev.ipogiba.homework.loms.pkg.api.loms.v1.Loms/OrderCancel",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Loms_StocksInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gitlab.ozon.dev.ipogiba.homework.loms.pkg.api.loms.v1.Loms/StocksInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Loms_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gitlab.ozon.dev.ipogiba.homework.loms.pkg.api.loms.v1.Loms",
